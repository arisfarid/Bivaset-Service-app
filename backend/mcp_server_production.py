#!/usr/bin/env python3
"""
Standalone Bivaset MCP Server - Compatible Version for Production
سرور MCP مستقل بیواست - نسخه سازگار برای تولید

This version is compatible with mcp==0.9.1 on production server
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/home/ubuntu/logs/mcp_server.log', encoding='utf-8'),
